...
object Build extends AutoPlugin {
  ...
  override def projectSettings = Vector(
    ...
    // Header settings
    HeaderPlugin.autoImport.headers := Map("scala" -> Apache2_0("2016", "Ben Ripkens")),

    // Assembly settings
    AssemblyPlugin.autoImport.assemblyJarName := "health-check-adapter.jar",
    mainClass := Some("de.bripkens.ha.App")
  )
}
